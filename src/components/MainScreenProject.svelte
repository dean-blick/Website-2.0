...
<div class="flex flex-row w-[calc(100%-40px)] card preset-filled-surface-100-900 m-2 p-3 md:w-[45rem]">
    ...
    <div class="flex flex-col justify-end items-end w-[20px] min-w-[20px] ml-auto">
        {#if info.GitHub != ""}
